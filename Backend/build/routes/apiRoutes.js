...
var ApiRoutes = /** @class */ (function () {
    ...
    ApiRoutes.prototype.config = function () {
        ...
        this.router.delete('/users/:idUsuario', userController_1.userController.deleteUser);
        ...
        this.router.delete('/products/:idProductos', productController_1.productController.deleteProducto);
        ...
        this.router.delete('/categories/:idProductos', productController_1.productController.deleteCategoria);
        //GoodActions Routes
        ...
        this.router.delete('/goodActions/:idAccion', goodActionsController_1.goodActionsController.deleteGoodAction);
    };
    return ApiRoutes;
}());
